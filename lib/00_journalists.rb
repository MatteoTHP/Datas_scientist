...
puts 
sleep(1)
puts ary.count{|name|  name.size==6 }
puts 
...
puts 
sleep(1)
stock= ary.count{|name| if name[1].upcase != name[1].downcase
...
stock= ary.count{|name|name[1] != name[1].downcase
...
while letters <= 33
    ...
    letters += 1
    if num > 0
        puts "Il y a #{num} handle avec #{letters-1} caractères ! "
    end
    num = 0
end
